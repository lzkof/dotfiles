...
require("lazy").setup({
	...
	{ -- Fuzzy Finder (files, lsp, etc)
		...
		config = function()
			...
			vim.keymap.set("n", "<leader>sc", builtin.colorscheme, { desc = "[S]earch [F]iles" })
	...
	--require 'custom.plugins.markdown-textwidth',
	...
	--require("custom.plugins.renderer-markdown"),
	--require 'custom.plugins.automake',
